...
const backgrounds = [
  ...
  { id: 5, name: '푸른 바다', image: require('../assets/background/under-the-sea1.png') },
  ...
  { id: 11, name: '파랑새가 사는 마을', image: require('../assets/background/village4.png') },
  { id: 12, name: '요정이 사는 숲속', image: require('../assets/background/forest3.png') },
];
